...
module.exports = (resolve, rootDir, isEjecting) => {
  ...
  const globalSetupFileExtension =
    (globalSetupMatches && globalSetupMatches[1]) || 'js';
  const globalSetupFile = fs.existsSync(paths.globalTestSetup)
    ? `<rootDir>/src/globalSetup.${globalSetupFileExtension}`
    : undefined;
